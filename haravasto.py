...
def lataa_kuvat(polku):
    ...
    kuvat["r"] = pyglet.resource.image("ruutu_miina_punainen.png")
    kuvat["icon"] = pyglet.resource.image("miina_lapinakuva.png")
...
def luo_ikkuna(leveys=800, korkeus=600, taustavari=(240, 240, 240, 255)):
    ...
    grafiikka["ikkuna"] = pyglet.window.Window(leveys, korkeus, "Miinaharava", resizable=True)
    grafiikka["ikkuna"].set_icon(grafiikka["kuvat"]["icon"])
